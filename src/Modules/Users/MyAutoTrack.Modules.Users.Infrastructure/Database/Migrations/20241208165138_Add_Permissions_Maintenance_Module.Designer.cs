...
namespace MyAutoTrack.Modules.Users.Infrastructure.Database.Migrations
{
    ...
    [Migration("20241208165138_Add_Permissions_Maintenance_Module")]
    partial class Add_Permissions_Maintenance_Module
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyAutoTrack.Modules.Users.Domain.Users.Permission", b =>
                {
            ...
            modelBuilder.Entity("MyAutoTrack.Modules.Users.Domain.Users.Role", b =>
                {
                    b.Property<string>("Name")
                        .HasMaxLength(50)
            ...
            modelBuilder.Entity("MyAutoTrack.Modules.Users.Domain.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PermissionRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            PermissionCode = "maintenance:read",
                            RoleName = "Member"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("PermissionRole", b =>
                {
                    b.HasOne("MyAutoTrack.Modules.Users.Domain.Users.Permission", null)
                        .WithMany()
                    ...
                    b.HasOne("MyAutoTrack.Modules.Users.Domain.Users.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RoleUser", b =>
                {
                    ...
                    b.HasOne("MyAutoTrack.Modules.Users.Domain.Users.User", null)
                        .WithMany()
