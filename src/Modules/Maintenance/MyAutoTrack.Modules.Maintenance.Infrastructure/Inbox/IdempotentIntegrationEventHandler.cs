...
namespace MyAutoTrack.Modules.Maintenance.Infrastructure.Inbox;
    ...
    where TIntegrationEvent : IIntegrationEvent
{
        ...
        InboxMessageConsumer inboxMessageConsumer)
    {
        const string sql =
            ...
            SELECT EXISTS(
                SELECT 1
                FROM maintenance.inbox_message_consumers
        ...
        InboxMessageConsumer inboxMessageConsumer)
    {
        const string sql =
            """
            INSERT INTO maintenance.inbox_message_consumers(inbox_message_id, name)
