...
namespace MyAutoTrack.Modules.Maintenance.Infrastructure.Outbox;
    ...
    where TDomainEvent : IDomainEvent
{
        ...
        OutboxMessageConsumer outboxMessageConsumer)
    {
        const string sql =
            ...
            SELECT EXISTS(
                SELECT 1
                FROM maintenance.outbox_message_consumers
        ...
        OutboxMessageConsumer outboxMessageConsumer)
    {
        const string sql =
            """
            INSERT INTO maintenance.outbox_message_consumers(outbox_message_id, name)
